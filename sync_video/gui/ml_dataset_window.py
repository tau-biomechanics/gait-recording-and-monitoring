...
class MLDatasetWindow(QMainWindow):
    ...
    def __init__(self, title, dataset, parent=None):
        ...
        # Set a reasonable initial width for the control panel
        viz_control_widget.setMinimumWidth(180)
        ...
        viz_splitter.addWidget(viz_control_widget)
        viz_splitter.addWidget(canvas_container)
        
        # Set default sizes (give more space to the chart)
        viz_splitter.setSizes([200, 800])
        
        # Make the splitter handle more visible
        viz_splitter.setHandleWidth(8)
        viz_splitter.setStyleSheet("""
            QSplitter::handle {
        ...
        # Add the splitter to the main visualization layout
        visualization_layout.addWidget(viz_splitter)
