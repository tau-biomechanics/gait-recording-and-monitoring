...
Modular version that uses the sync_video package for better organization.
"""
...
from sync_video.gui import SynchronizedVideoPlayer
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description="Synchronized visualization of video and biomechanical data"
    )
    parser.add_argument(
        "--video",
